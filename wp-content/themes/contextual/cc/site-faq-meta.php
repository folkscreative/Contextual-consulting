<?php
/**
 * Site FAQ Category meta fields
 * * see https://en.bainternet.info/wordpress-taxonomies-extra-fields-the-easy-way/
 */
...
*/
$config = array(
   'id' => 'site_faq_meta_box',                         // meta box id, unique per meta box
   'title' => 'Site FAQ Meta Box',                      // meta box title
   'pages' => array('sitefaqcat'),                    // taxonomy name, accept categories, post_tag and custom taxonomies
...
$my_meta->addText( 'sitefaqcat_order', array( 'name' => 'Order' ) );

...
/**
 * v4.3.0.2 Jan 2023
 * - added the data-bs-auto-close="outside" to ensure that dropdown menu items do not close on click
 * v4.3.0.1 Mar 2021
 * - Modified for WMS v6
 * - changed the data tag on dropdowns
 */
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				$fallback_output .= '<a href="#" class="my-closer">&times;</a>';
				$fallback_output .= '<ul';
				if ( $menu_id ) {
